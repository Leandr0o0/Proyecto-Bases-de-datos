...
| Archivo | Propósito |
|---|---|
| `01_seed_master.sql` | Pobla episode, map, user, player, game, BANGS (ux_instrument/ux_item), y respuestas UX |
| `02_etl_pipeline.sql` | Pipeline completo: staging → sector → telemetry_event |
...
#### 3. Ejecutar el bloque ALTER de `02_etl_pipeline.sql` (solo una vez)
...
Ejecutar el resto de `02_etl_pipeline.sql` desde el PASO 1 hasta el final.
